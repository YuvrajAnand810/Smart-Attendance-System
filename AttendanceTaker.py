...
class Face_Recognizer:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "Smart Attendance System Based On ML", (20, 40), self.font, 1, (255, 255, 255), 1,
                    cv2.LINE_AA)
        # cv2.putText(img_rd, "Frame:  " + str(self.frame_cnt), (20, 100), self.font, 0.8, (0, 255, 0), 1,
        #             cv2.LINE_AA)
        # cv2.putText(img_rd, "FPS:    " + str(self.fps.__round__(2)), (20, 130), self.font, 0.8, (0, 255, 0), 1,
        #             cv2.LINE_AA)
        cv2.putText(img_rd, "Faces:  " + str(self.current_frame_face_cnt), (20, 100), self.font, 0.8, (0, 255, 0), 1,
                    cv2.LINE_AA)
                ...
                if (self.current_frame_face_cnt == self.last_frame_face_cnt) and (
                    ...
                    for i in range(self.current_frame_face_cnt):
                        ...
                        img_rd = cv2.putText(img_rd, self.current_frame_face_name_list[i],
                                             self.current_frame_face_position_list[i], self.font, 0.8, (0, 255, 0), 1,
                                             cv2.LINE_AA)
